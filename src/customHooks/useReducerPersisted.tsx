...
const persistReducer =
  <R extends Reducer<any, any>>(reducer: R, key?: string) =>
...
const useReducerPersisted = <R extends Reducer<any, any>, I>(reducer: R, initialState: I, persistKey?: string): [ReducerState<R>, Dispatch<ReducerAction<R>>] => {
